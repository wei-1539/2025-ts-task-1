...
export const cart: Array<{sku:string,name:string,qty:number,price:number,potColor?:string}> /* TODO: 陣列包物件的型別定義 > */ = [
...
export type BasicPlant = /* TODO: { id: 型別; name: 型別; price: 型別 } */  { id: number; name: string; price: number };
export type StockInfo = /* TODO: { sku: 型別; quantity: 型別 } */  { sku: string; quantity: number };
...
// 目標：理解介面擴充多重介面的寫法。
export interface Price { /* TODO: price: 型別; currency:"TWD"|"USD" */ price: number; currency:string; }
export interface Shippable { /* TODO: weightKg: 型別; shipFrom: 型別 */ weightKg: number; shipFrom: string; }
...
export const calcTotal: CalcTotalFn /* TODO: CalcTotalFn */ = (items, coupon) => {
...
export function updatePlant(input:Partial<PlantBase> /* TODO */): /* TODO */  Required<PlantBase> {
  const existing: /* TODO */  Required<PlantBase> = { id: 1, name: "虎尾蘭", price: 480, description: "耐陰、淨化空氣" };
...
// 說明：用 Record 表示庫存表。
// 目標：以字串鍵對應到嚴格結構。
export type Inventory = Record<string, number> /* TODO */ ;
...
export const cartPlant: CartPlant /* TODO */ = { id: 101, name: "琴葉榕", price: 2500 };
export const publicPlant: PublicPlant /* TODO */ = { id: 101, name: "琴葉榕", price: 2500, currency: "TWD" };
...
const submitProduct = (type: "create"|"update", product: TCreateProduct) => {
  if(type === "create"){
